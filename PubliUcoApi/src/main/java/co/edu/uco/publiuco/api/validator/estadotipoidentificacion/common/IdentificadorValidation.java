package co.edu.uco.publiuco.api.validator.estadotipoidentificacion.common;
...
public final class IdentificadorValidation implements Validation<UUID> {
	...
	public Result execute(UUID data) {
		...
		if (UtilObject.isNull(data)) {
			result.addMessage(EstadoTipoIdentificacionValidationMessages.IDENTIFICADOR_IS_NULL);
		} else if (UtilUUID.isDefault(data)) {
			result.addMessage(EstadoTipoIdentificacionValidationMessages.IDENTIFICADOR_IS_DEFAULT);
		}
